package spring.abel.microservices.account.api;

import lombok.extern.slf4j.Slf4j;
import spring.abel.microservices.account.exceptions.AccountNotFoundException;
import spring.abel.microservices.account.model.Account;
...
public class Api {
    ...
    @RequestMapping(method = RequestMethod.DELETE, value = "/check/{id}")
